...
class MSMT17_SCT(BaseImageDataset):
    """
    MSMT17
    ...
    # cameras: 15
    """
    dataset_dir = 'MSMT17_sct'
    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        super(MSMT17_SCT, self).__init__()
        self.pid_begin = pid_begin
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.train_dir = osp.join(self.dataset_dir, 'train_sct')
        self.test_dir = osp.join(self.dataset_dir, 'test')
        self.list_train_path = osp.join(self.dataset_dir, 'list_train.txt')
        # self.list_train_path = osp.join(self.dataset_dir, 'MSMT_mixSCT.txt')
